function [G, H_hat, H, alpha] = assembly_quadratic_prova(triangles, face_normals, ...
...
if nargout >= 3
    ...
    writematrix(H_hat, 'H_hat_prova.csv');
    writematrix(H, 'H_prova.csv');
    writematrix(G, 'G_prova.csv');
end
