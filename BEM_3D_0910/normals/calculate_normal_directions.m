function normals = calculate_normal_directions(meshData)
    % Calcola i vettori normali per ogni triangolo della mesh
    %
    % INPUT:
    ...
    %
    % OUTPUT:
    % normals - Matrice (numTriangles x 3) contenente i vettori normali
    ...
    % Loop su ogni triangolo per calcolare il vettore normale
    for i = 1:numTriangles
        ...
        % Assegniamo il normale alla matrice
        normals(i, :) = normal;
    end
end
