...
%%QUESTE FUNZIONI DI ASSEGNAZIONE RESTANO UGUALI
...
%%le seguenti funzioni permangono perche' assegna il valore della soluzione
%%costante per ogni triangolo facendo la media dei punti (6 anziche' 3) ma
%%accede a TR.ConnectivityList quindi sono gia' 6. Lasciare cosi'.
...
%% POST PROCESSING DA MODIFICARE (SOLO TRISURF NON VA, CAPIRE COME FARE MESH)
